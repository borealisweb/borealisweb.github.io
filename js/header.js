document.addEventListener("DOMContentLoaded", () => {
  ...
  const depth1Paths = [
    "/blog", "gestion", "/angel-gomez", "/virginia-fernandez", "/walkiria-jimenez",
    "/inicio", "/contacto", "/nosotros", "/acerca-de-mi", "/briefing", "/branding",
    "/packaging", "/soluciones-audiovisuales", "/portafolio-web", "/social-media",
    "/flyers", "/soluciones-creativas", "/aviso-legal", "/politica-de-privacidad", "/terminos-y-condiciones"
  ];

  if (depth1Paths.some(p => path.includes(p))) {
    prefix = "../";
  }
          ...
          <div class="portfolio-dashboard-col">
              ...
              <div class="portfolio-grid">
                  <a href="${prefix}inicio/#branding" class="portfolio-card">
                      ...
                      <div class="portfolio-text"><h4>Identidad Visual</h4><p>Creación y diseño de identidad de marca</p></div>
                  </a>
                  <a href="${prefix}inicio/#packaging" class="portfolio-card">
                      <div class="portfolio-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16.5 9.4 7.55 4.24"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg></div>
                      <div class="portfolio-text"><h4>Packaging</h4><p>Diseño de empaques y etiquetas</p></div>
                  </a>
