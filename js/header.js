  ...
  const headerHTML = `
    <div class="col left">
      ...
      <nav class="menu-links">
        ...
        <a href="${prefix}index.html#portafolio" class="smooth-scroll">Portafolio</a>
        <a href="${prefix}soluciones-audiovisuales.html">Videos</a>
        <a href="${prefix}blog.html">Blog</a>
        <a href="${prefix}contacto.html" target="_blank">
    ...
    <div class="col right">
      <a href="${prefix}contacto.html" class="btn-accent">Agendar Cita</a>
