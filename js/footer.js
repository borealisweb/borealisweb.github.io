document.addEventListener("DOMContentLoaded", () => {
  ...
  if (path.includes("/blog") || path.includes("/inicio") || path.includes("/contacto") || path.includes("/acerca-de-mi") || path.includes("/briefing")  || path.includes("/branding") || path.includes("/packaging") || path.includes("/soluciones-audiovisuales") || path.includes("/social-media") || path.includes("/flyers") || path.includes("/soluciones-creativas")  || path.includes("/aviso-legal")  || path.includes("/politica-de-privacidad")  || path.includes("/terminos-y-condiciones")) {
    prefix = "../";
  }
